...
const MicroBitConverter = {
    register: function (converter) {
        const createMicrobitBlock = (node) =>
            converter.createRubyExpressionBlock(MicroBit, node);
                ...
                switch (args[0].value) {
                    case "microbit_button_pressed":
                        return converter.callMethod(
                            createMicrobitBlock(params.node),
                            "when_button_pressed",
                            params.args.slice(1),
                            params.rubyBlockArgs,
                            params.rubyBlock,
                            params.node
                        );
