...
//    "gui.m5stack.description": "M5stack．モニタ表示",
    ...
    "mctboard.sd_gets":   'SD: ファイル出力[MODE]',
    /*
    "mctboard3.lng": '経度',
    "mctboard3.lat": '緯度',
    "mctboard3.temp": '温度',
...
//    "peripherals.gps_clear": 'GPS: バッファクリア',
    ...
    "peripherals.sd_umount": 'SD: マウント解除',
    "peripherals.lcd_init": 'LCD: [SENSOR] 初期化',
    "peripherals.lcd_cursor": 'LCD: [SENSOR] カーソルを[LINE]行目に',
    "peripherals.lcd_print": 'LCD: [SENSOR] に[TEXT]表示',
    "peripherals.lcd_clear": 'LCD: [SENSOR] 画面クリア',    
