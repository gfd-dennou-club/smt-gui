...
export default function (Generator) {
    Generator.looks_sayforsecs = function (block) {
        const message =
            Generator.valueToCode(block, "MESSAGE", Generator.ORDER_NONE) ||
            Generator.quote_("");
        const secs =
            Generator.valueToCode(block, "SECS", Generator.ORDER_NONE) || "0";
    ...
    Generator.looks_switchcostumeto = function (block) {
        const costume =
            Generator.valueToCode(block, "COSTUME", Generator.ORDER_NONE) ||
            null;
        return `switch_costume(${costume})\n`;
    };

    Generator.looks_costume = function (block) {
        const costume = Generator.quote_(
            Generator.getFieldValue(block, "COSTUME") || null
        );
    ...
    Generator.looks_switchbackdropto = function (block) {
        const backdrop =
            Generator.valueToCode(block, "BACKDROP", Generator.ORDER_NONE) ||
            null;
        return `switch_backdrop(${backdrop})\n`;
    };

    Generator.looks_backdrops = function (block) {
        const backdrop = Generator.quote_(
            Generator.getFieldValue(block, "BACKDROP") || null
        );
    ...
    Generator.looks_changesizeby = function (block) {
        const change =
            Generator.valueToCode(block, "CHANGE", Generator.ORDER_NONE) || "0";
        return `self.size += ${change}\n`;
    };

    Generator.looks_setsizeto = function (block) {
        const size =
            Generator.valueToCode(block, "SIZE", Generator.ORDER_NONE) || "0";
        return `self.size = ${size}\n`;
    };

    Generator.looks_changeeffectby = function (block) {
        const effect = Generator.quote_(
            Generator.getFieldValue(block, "EFFECT").toLowerCase() || ""
        );
        const change =
            Generator.valueToCode(block, "CHANGE", Generator.ORDER_NONE) || "0";
    ...
    Generator.looks_gotofrontback = function (block) {
        const frontBack = Generator.quote_(
            Generator.getFieldValue(block, "FRONT_BACK") || "front"
        );
    ...
    Generator.looks_goforwardbackwardlayers = function (block) {
        ...
        const forwardBackward = Generator.quote_(
            Generator.getFieldValue(block, "FORWARD_BACKWARD") || "forward"
        );
    ...
    Generator.looks_costumenumbername = function (block) {
        const numberName =
            Generator.getFieldValue(block, "NUMBER_NAME") || "number";
