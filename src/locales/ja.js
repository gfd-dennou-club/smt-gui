export default {
    ...
    'gui.smalruby3.extension.meshV2.description': 'GraphQLを使用した新しいメッシュ拡張機能。',
    'gui.smalruby3.extension.meshV2.connectingMessage': 'メッシュ V2のネットワークに接続しています',
    'mesh.hostPeripheralNameV2': 'メッシュ V2のホストになる 【{ MESH_ID }】',
    'mesh.clientPeripheralNameV2': 'メッシュ V2に参加する 【{ MESH_ID }】',
    'mesh.registeredHostV2': 'ホストとしてメッシュ V2に登録しました 【{ MESH_ID }】{ EXPIRES_AT }',
