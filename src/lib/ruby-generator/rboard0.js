...
export default function (Generator) {
    Generator.rboard0_gpio_output_init = function (block){
        const num1 = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        return `led${num1} = GPIO.new( ${num1}, GPIO::OUT )\n`;
    };

    Generator.rboard0_gpio_output = function (block) {
        const num1  = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        const value = Generator.getFieldValue(block, 'VALUE', Generator.ORDER_NONE);
        return `led${num1}.write(${value})\n`;
    };

    Generator.rboard0_gpio_input_init = function (block){
        const num1 = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        return `sw${num1} = GPIO.new( ${num1}, GPIO::IN|GPIO::PULL_UP ) \n`;
    };

    Generator.rboard0_gpio_input = function (block) {
        const num1 = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        return [`sw${num1}.read`, Generator.ORDER_ATOMIC];
    };

    Generator.rboard0_pwm_init = function (block){
        const num1 = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        return `pwm${num1} = PWM.new( ${num1}, frequency:440 )\n`;
    };

    Generator.rboard0_pwm_duty = function (block) {
        const num1  = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        const value = Generator.valueToCode(block, 'VALUE', Generator.ORDER_NONE) || null;
        return `pwm${num1}.duty( ( ${value} % 101 ).to_i )\n`;
    };

    Generator.rboard0_pwm_frequency = function (block) {
        const num1  = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        const value = Generator.valueToCode(block, 'VALUE', Generator.ORDER_NONE) || null;
        return `pwm${num1}.frequency( ${value}.to_i )\n`;
    };

    Generator.rboard0_adc_init = function (block) {
        const num1 = Generator.getFieldValue(block, 'NUM1', Generator.ORDER_NONE);
        return `adc${num1} = ADC.new( ${num1} )\n`;
    };

    Generator.rboard0_adc_volt = function (block) {
        const value = Generator.getFieldValue(block, 'VALUE', Generator.ORDER_NONE);
        return [`adc${value}.read`, Generator.ORDER_ATOMIC];
    };
/*
    Generator.rboard0_i2c_init = function (block) {
        return `i2c = I2C.new()\n`;
    };

    Generator.rboard0_i2c_write = function (block) {
    ...
    Generator.rboard0_i2c_read = function (block) {
        const num1 = Generator.valueToCode(block, 'NUM1', Generator.ORDER_NONE) || null;
