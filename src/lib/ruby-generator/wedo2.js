...
export default function (Generator) {
    Generator.wedo2_menu_MOTOR_ID = function (block) {
        const motorId = Generator.quote_(
            Generator.getFieldValue(block, "MOTOR_ID") || "motor"
        );
    ...
    Generator.wedo2_motorOnFor = function (block) {
        const motorId =
            Generator.valueToCode(block, "MOTOR_ID", Generator.ORDER_NONE) ||
            null;
        const duration =
            Generator.valueToCode(block, "DURATION", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.wedo2_startMotorPower = function (block) {
        const motorId =
            ...
            null;
        const power =
            Generator.valueToCode(block, "POWER", Generator.ORDER_NONE) || null;
        return `wedo2.set_power(${motorId}, ${power})\n`;
    };

    Generator.wedo2_menu_MOTOR_DIRECTION = function (block) {
        const motorDirection = Generator.quote_(
            Generator.getFieldValue(block, "MOTOR_DIRECTION") || "this way"
        );
    ...
    Generator.wedo2_setLightHue = function (block) {
        const hue =
            Generator.valueToCode(block, "HUE", Generator.ORDER_NONE) || null;
        return `wedo2.light_color = ${hue}\n`;
    };

    Generator.wedo2_menu_OP = function (block) {
        const op = Generator.quote_(
            Generator.getFieldValue(block, "OP") || "<"
        );
    ...
    Generator.wedo2_whenDistance = function (block) {
        ...
        const op =
            Generator.valueToCode(block, "OP", Generator.ORDER_NONE) || null;
        const reference =
            Generator.valueToCode(block, "REFERENCE", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.wedo2_menu_TILT_DIRECTION_ANY = function (block) {
        const tiltDirectionAny = Generator.quote_(
            Generator.getFieldValue(block, "TILT_DIRECTION_ANY") || "any"
        );
    ...
    Generator.wedo2_menu_TILT_DIRECTION = function (block) {
        const tiltDirection = Generator.quote_(
            Generator.getFieldValue(block, "TILT_DIRECTION") || "up"
        );
