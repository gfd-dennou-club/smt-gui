...
export default function (Generator) {
    Generator.sound_sounds_menu = function (block) {
        const sound = Generator.quote_(
            Generator.getFieldValue(block, "SOUND_MENU") || ""
        );
    ...
    Generator.sound_playuntildone = function (block) {
        const sound =
            Generator.valueToCode(block, "SOUND_MENU", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.sound_changeeffectby = function (block) {
        const effect = Generator.quote_(
            Generator.getFieldValue(block, "EFFECT") || ""
        );
        const value =
    ...
    Generator.sound_changevolumeby = function (block) {
        const volume =
            Generator.valueToCode(block, "VOLUME", Generator.ORDER_NONE) || "0";
