export default {
    ...
    'gui.smalruby3.extension.meshV2.description': 'A new Mesh extension using GraphQL.',
    'gui.smalruby3.extension.meshV2.connectingMessage': 'Connecting to Mesh V2 network',
    'mesh.hostPeripheralNameV2': 'Become Mesh V2 Host [{ MESH_ID }]',
    'mesh.clientPeripheralNameV2': 'Join Mesh V2 [{ MESH_ID }]',
    'mesh.registeredHostV2': 'Registered Host Mesh V2 [{ MESH_ID }]{ EXPIRES_AT }',
    'mesh.joinedMeshV2': 'Joined Mesh V2 [{ MESH_ID }]',
    'mesh.expiresAtV2': ' (Expires at { TIME })',
    'mesh.notConnectedV2': 'Not connected (Mesh V2)',
