...
export default function (Generator) {
    ...
    Generator.videoSensing_videoToggle = function (block) {
        const videoState = Generator.valueToCode(
            block,
            "VIDEO_STATE",
    ...
    Generator.videoSensing_menu_VIDEO_STATE = function (block) {
        const videoState = Generator.quote_(
            Generator.getFieldValue(block, "VIDEO_STATE") || "on"
        );
    ...
    Generator.videoSensing_videoOn = function (block) {
        const attribute = Generator.valueToCode(
            block,
            "ATTRIBUTE",
            Generator.ORDER_NONE
        );
        const subject = Generator.valueToCode(
            block,
            "SUBJECT",
            Generator.ORDER_NONE
        );
        return [
            `video_sensing.video_on(${attribute}, ${subject})`,
            Generator.ORDER_ATOMIC,
        ];
    };

    Generator.videoSensing_menu_ATTRIBUTE = function (block) {
        const attribute = Generator.quote_(
            Generator.getFieldValue(block, "ATTRIBUTE") || "motion"
        );
        return [attribute, Generator.ORDER_ATOMIC];
    };

    Generator.videoSensing_menu_SUBJECT = function (block) {
        const subject = Generator.quote_(
            Generator.getFieldValue(block, "SUBJECT") || "this sprite"
        );
