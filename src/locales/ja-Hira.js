export default {
    ...
    "gui.smalruby3.telemetryOptIn.label":
        "スモウルビーをかいぜんするためのりようじょうきょうのほうこく",
    ...
    "gui.smalruby3.extension.mesh.description":
        "ネットワークじょうでユーザーかんのやりとりをおこなう。",
    "gui.extension.sample.name": "るびーくらぶ",
    "gui.extension.sample.description": "るびーくらぶ",
    ...
    "smalrubotS1.getMotorSpeed":
        "[POSITION] DC (ディーシー) モーターのそくど (%)",
    "smalrubotS1.setMotorSpeed":
        "[POSITION] DC (ディーシー) モーターのそくどを [SPEED] (%) にする",
    ...
    "gui.extension.rubyclub.name": "るびーくらぶ",
    "gui.extension.rubyclub.description": "るびーくらぶ",
    "rubyclub.name": "さんぷる",
    "rubyclub.command0": "こまんど",
    "rubyclub.command1": "こまんど[TEXT][NUM]",
    "rubyclub.command2": "こまんど[TEXT1]",
    "rubyclub.command3": "こまんど[TEXT1] [NUM1]",
    "rubyclub.flag0": "しんぎ",    
    "rubyclub.value0": "あたい",   
    "gui.extension.kaniroboNormal.name": "かにろぼ(ふつう)",
    "gui.extension.kaniroboNormal.description": "かにろぼ(ふつう)",
    "kaniroboNormal.name": "かにろぼ(ふつう)", 
    "KaniroboNormal.Menu1.forward": "まえ",
    "KaniroboNormal.Menu1.backward": "うしろ",
    "KaniroboNormal.Menu3.enable": "ゆうこう",
    "KaniroboNormal.Menu3.disable": "むこう",
    "kaniroboNormal.command0": "もーたーゆうこうかぴんをしょきか",
    "kaniroboNormal.command1": "もーたーゆうこうかぴんを[TEXT1]か",
    "kaniroboNormal.command2": "もーたー[TEXT2]をしょきか",
    "kaniroboNormal.command3": "もーたー[TEXT5]のすぴーどをしょきか",
    "kaniroboNormal.command4": "もーたー[TEXT2]を[TEXT3]ほうこうにせっと",
    "kaniroboNormal.command5": "もーたー[TEXT5]のすぴーどを[NUM]にする",
    "kaniroboNormal.command6": "らいとせんさー[TEXT4]をしょきか",
    "kaniroboNormal.value0": "らいとせんさー[TEXT4]のあたい",
    "kaniroboNormal.command7": "さーぼもーたー[TEXT7]をしょきか",
    "kaniroboNormal.command8": "さーぼもーたー[TEXT6]のしゅうはすうを[NUM]にする",
    "kaniroboNormal.command9": "さーぼもーたー[TEXT6]のでゅーてぃーひを[NUM]にする",
    "kaniroboNormal.value1": "[NUM]ど",
};
