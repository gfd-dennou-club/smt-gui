export default {
    ...
    "sample.flag0": "真偽",
    "sample.value0": "値",
    "GPIOeasy.LED": "LED 1[NUM1] 2[NUM2] 3[NUM3] 4[NUM4] 5[NUM5] 6[NUM6] 7[NUM7] 8[NUM8]",
    "GPIOeasy.switch": "スイッチ 1[SWITCH1] 2[SWITCH2] 3[SWITCH3] 4[SWITCH4]",
    "GPIOeasy.sound": "[SCALE]の音を鳴らす",
    "GPIOeasy.sound_stop": "音を止める",
    "GPIOeasy.temperature": "温度",
};
