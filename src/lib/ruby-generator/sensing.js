...
export default function (Generator) {
    Generator.sensing_touchingobject = function (block) {
        ...
        const object =
            Generator.valueToCode(block, "TOUCHINGOBJECTMENU", order) || null;
        return [`touching?(${object})`, order];
    };

    Generator.sensing_touchingobjectmenu = function (block) {
        const object = Generator.quote_(
            Generator.getFieldValue(block, "TOUCHINGOBJECTMENU") || null
        );
    ...
    Generator.sensing_distanceto = function (block) {
        const order = Generator.ORDER_FUNCTION_CALL;
        const object =
            Generator.valueToCode(block, "DISTANCETOMENU", order) || null;
        return [`distance(${object})`, order];
    };

    Generator.sensing_distancetomenu = function (block) {
        const object = Generator.quote_(
            Generator.getFieldValue(block, "DISTANCETOMENU") || null
        );
        return [object, Generator.ORDER_ATOMIC];
    };
    ...
    Generator.sensing_askandwait = function (block) {
        const question =
            Generator.valueToCode(block, "QUESTION", Generator.ORDER_NONE) ||
            null;
        return `ask(${question})\n`;
    };
    ...
    Generator.sensing_keyoptions = function (block) {
        const key = Generator.quote_(
            Generator.getFieldValue(block, "KEY_OPTION") || ""
        );
    ...
    Generator.sensing_setdragmode = function (block) {
        const mode = Generator.quote_(
            Generator.getFieldValue(block, "DRAG_MODE") || ""
        );
    ...
    Generator.sensing_of = function (block) {
        ...
        const object =
            Generator.valueToCode(block, "OBJECT", Generator.ORDER_ATOMIC) ||
            null;
    ...
    Generator.sensing_current = function (block) {
        ...
        return [
            `Time.now.${currentMenuToMethod[menu]}`,
