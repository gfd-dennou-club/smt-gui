...
*/    
    ...
    //
    "microcom.name": "汎用",
    "microcom.gpio_output_init": "GPIO (出力): [PIN]ピンを初期化",
    "microcom.gpio_write": "GPIO (出力): [PIN]ピンの値を [VALUE] にする",
    "microcom.gpio_input_init": "GPIO (入力): [PIN]ピンを初期化",
    "microcom.gpio_read": "GPIO (入力): [PIN]ピンの値",
