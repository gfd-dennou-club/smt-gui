...
export default function (Generator) {
    ...
    Generator.operator_random = function (block) {
        const fromNum =
            Generator.valueToCode(block, "FROM", Generator.ORDER_RANGE) || 1;
        const toNum =
            Generator.valueToCode(block, "TO", Generator.ORDER_RANGE) || 10;
    ...
    Generator.operator_gt = function (block) {
        ...
        return [
            `${Generator.nosToCode(operand1)} > ${Generator.nosToCode(
                operand2
            )}`,
            order,
        ];
    ...
    Generator.operator_and = function (block) {
        ...
        const operand1 =
            Generator.valueToCode(block, "OPERAND1", order) || "false";
        const operand2 =
            Generator.valueToCode(block, "OPERAND2", order) || "false";
    ...
    Generator.operator_not = function (block) {
        ...
        const operand =
            Generator.valueToCode(block, "OPERAND", order) || "false";
    ...
    Generator.operator_join = function (block) {
        const order = Generator.ORDER_ADDITIVE;
        const rightStr =
            Generator.valueToCode(block, "STRING1", order) ||
            Generator.quote_("");
        const leftStr =
            Generator.valueToCode(block, "STRING2", order) ||
            Generator.quote_("");
    ...
    Generator.operator_letter_of = function (block) {
        ...
        const str =
            Generator.valueToCode(block, "STRING", order) ||
            Generator.quote_("");
        const letter =
            Generator.valueToCode(block, "LETTER", Generator.ORDER_INDEX) - 1 ||
            "0";
    ...
    Generator.operator_contains = function (block) {
        const str1 =
            Generator.valueToCode(block, "STRING1", Generator.ORDER_NONE) ||
            Generator.quote_("");
        const str2 =
            Generator.valueToCode(block, "STRING2", Generator.ORDER_NONE) ||
            Generator.quote_("");
