...
const StopOptions = ["all", "this script", "other scripts in sprite"];
            ...
            switch (name) {
                ...
                case "repeat":
                    if (
                        ...
                        block = createControlRepeatBlock.call(
                            this,
                            args[0],
                            rubyBlock
                        );
                ...
                case "stop":
                    if (
                        ...
                        StopOptions.indexOf(args[0].toString()) >= 0
                    ) {
                ...
                case "create_clone":
                    if (args.length === 1 && this._isString(args[0])) {
                        ...
                        const optionBlock = this._createBlock(
