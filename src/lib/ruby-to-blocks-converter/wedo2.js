...
const MotorIdMenu = ["motor", "motor A", "motor B", "all motors"];
const MotorIdMenuLower = MotorIdMenu.map((x) => x.toLowerCase());

const MotorDirectionMenu = ["this way", "that way", "reverse"];

const OpMenu = ["<", ">"];

const TiltDirectionAnyMenu = ["up", "down", "left", "right", "any"];
    ...
    register: function (converter) {
        ...
        converter.registerCallMethod(Wedo2, "turn_on_for", 2, (params) => {
            ...
            if (converter.isString(args[0])) {
                const index = MotorIdMenuLower.indexOf(
        ...
        converter.registerCallMethod(Wedo2, "turn_on", 1, (params) =>
            createMotorToggleBlock("wedo2_motorOn", params)
        );
        converter.registerCallMethod(Wedo2, "turn_off", 1, (params) =>
            createMotorToggleBlock("wedo2_motorOff", params)
        );
        ...
        converter.registerCallMethod(Wedo2, "set_direction", 2, (params) => {
            ...
            if (converter.isString(args[1])) {
                const index = MotorDirectionMenu.indexOf(
        ...
        converter.registerCallMethodWithBlock(
            ...
            (params) => {
                ...
                if (
                    ...
                    OpMenu.indexOf(args[0].toString()) < 0
                )
                    return null;
                if (!converter.isNumberOrBlock(args[1])) return null;
