...
export default function (Generator) {
    Generator.music_playDrumForBeats = function (block) {
        const drum =
            Generator.valueToCode(block, "DRUM", Generator.ORDER_NONE) || null;
        const beats =
            Generator.valueToCode(block, "BEATS", Generator.ORDER_NONE) || 0;
    ...
    Generator.music_playNoteForBeats = function (block) {
        const note =
            Generator.valueToCode(block, "NOTE", Generator.ORDER_NONE) || 0;
        const beats =
            Generator.valueToCode(block, "BEATS", Generator.ORDER_NONE) || 0;
    ...
    Generator.music_setInstrument = function (block) {
        const instrument =
            Generator.valueToCode(block, "INSTRUMENT", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.music_setTempo = function (block) {
        const tempo =
            Generator.valueToCode(block, "TEMPO", Generator.ORDER_NONE) || 0;
