...
export default function (Generator) {
    Generator.smalrubotS1_action = function (block) {
        const action = Generator.quote_(
            Generator.getFieldValue(block, "ACTION", Generator.ORDER_NONE) ||
                "forward"
        );
    ...
    Generator.smalrubotS1_actionAndStopAfter = function (block) {
        ...
        const secs =
            Generator.valueToCode(block, "SECS", Generator.ORDER_NONE) || 1;
        return `smalrubot_s1.action(${action}, ${secs})\n`;
    };

    Generator.smalrubotS1_bendArm = function (block) {
        const degree =
            Generator.valueToCode(block, "DEGREE", Generator.ORDER_NONE) || 90;
        const secs =
            Generator.valueToCode(block, "SECS", Generator.ORDER_NONE) || 1;
    ...
    Generator.smalrubotS1_getSensorValue = function (block) {
        const position = Generator.quote_(
            Generator.getFieldValue(block, "POSITION", Generator.ORDER_NONE) ||
                "left"
        );
        return [
            `smalrubot_s1.sensor_value(${position})`,
    ...
    Generator.smalrubotS1_getMotorSpeed = function (block) {
        ...
        return [
            `smalrubot_s1.get_motor_speed(${position})`,
            Generator.ORDER_ATOMIC,
        ];
    };
    ...
    Generator.smalrubotS1_setMotorSpeed = function (block) {
        ...
        const speed =
            Generator.valueToCode(block, "SPEED", Generator.ORDER_NONE) || 1;
        return `smalrubot_s1.set_motor_speed(${position}, ${speed})\n`;
    };

    Generator.smalrubotS1_setArmCalibration = function (block) {
        const degree =
            Generator.valueToCode(block, "DEGREE", Generator.ORDER_NONE) || 0;
