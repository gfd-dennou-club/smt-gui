...
//
    "kanirobo2.name": "蟹ロボ",
    "kanirobo2.MenuSetGpio.forward": "1",
    "kanirobo2.MenuSetGpio.backward": "0",
    "kanirobo2.Menu3.enable": "有効",
    "kanirobo2.Menu3.disable": "無効",
    "kanirobo2.command0": "モーター有効化ピンを初期化",
    "kanirobo2.command1": "モーター有効化ピンを[TEXT]化",
    "kanirobo2.ResetGpio": "モーター[TEXT]のGPIOを初期化",
    "kanirobo2.ResetPwm": "モーター[TEXT]のPWMを初期化",
    "kanirobo2.SetGpio": "モーター[TEXT1]のGPIOを[TEXT2](1:前,0:後)にセット",
    "kanirobo2.SetPwm": "モーター[TEXT]のPWMのデューティー比を[NUM]% にセット",
    "kanirobo2.ResetLightSensor": "ライトセンサー[TEXT]を初期化",
    "kanirobo2.LightSensorValue": "ライトセンサー[TEXT]の値",
    "kanirobo2.ResetServoMotor": "サーボモーター[TEXT]を初期化．周期[NUM]ミリ秒",
    "kanirobo2.SetServoMotorPluseWigth": "サーボモーター[TEXT]のパルス幅を[NUM]ミリ秒にする",
    //
    "m5stack.line1": "線",
    "m5stack.line2": "四角",
