...
export default function (Generator) {
    Generator.gdxfor_menu_gestureOptions = function (block) {
        const gesture = Generator.quote_(
            Generator.getFieldValue(block, "gestureOptions") || "shaken"
        );
    ...
    Generator.gdxfor_menu_pushPullOptions = function (block) {
        const pushPull = Generator.quote_(
            Generator.getFieldValue(block, "pushPullOptions") || "pushed"
        );
    ...
    Generator.gdxfor_whenForcePushedOrPulled = function (block) {
        block.isStatement = true;
        const pushPull =
            Generator.valueToCode(block, "PUSH_PULL", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.gdxfor_menu_tiltAnyOptions = function (block) {
        const tiltAny = Generator.quote_(
            Generator.getFieldValue(block, "tiltAnyOptions") || "any"
        );
    ...
    Generator.gdxfor_whenTilted = function (block) {
        block.isStatement = true;
        const tilt =
            Generator.valueToCode(block, "TILT", Generator.ORDER_NONE) || null;
    ...
    Generator.gdxfor_menu_tiltOptions = function (block) {
        const tilt = Generator.quote_(
            Generator.getFieldValue(block, "tiltOptions") || "front"
        );
    ...
    Generator.gdxfor_menu_axisOptions = function (block) {
        const pushPull = Generator.quote_(
            Generator.getFieldValue(block, "axisOptions") || "z"
        );
        return [pushPull, Generator.ORDER_ATOMIC];
    };
