...
export default function (Generator) {
    Generator.motion_movesteps = function (block) {
        const steps =
            Generator.valueToCode(block, "STEPS", Generator.ORDER_NONE) || 0;
        return `move(${steps})\n`;
    };

    Generator.motion_turnright = function (block) {
        const degrees =
            Generator.valueToCode(block, "DEGREES", Generator.ORDER_NONE) || 0;
    ...
    Generator.motion_goto_menu = function (block) {
        const place = Generator.quote_(
            Generator.getFieldValue(block, "TO") || null
        );
    ...
    Generator.motion_pointtowards = function (block) {
        const towards = Generator.valueToCode(
            block,
            "TOWARDS",
    ...
    Generator.motion_pointtowards_menu = function (block) {
        const towards = Generator.quote_(
            Generator.getFieldValue(block, "TOWARDS") || "_mouse_"
        );
    ...
    Generator.motion_changexby = function (block) {
        const dx =
            Generator.valueToCode(block, "DX", Generator.ORDER_NONE) || 0;
        return `self.x += ${dx}\n`;
    };
    ...
    Generator.motion_changeyby = function (block) {
        const dy =
            Generator.valueToCode(block, "DY", Generator.ORDER_NONE) || 0;
        return `self.y += ${dy}\n`;
    };
    ...
    Generator.motion_setrotationstyle = function (block) {
        const style = Generator.quote_(
            Generator.getFieldValue(block, "STYLE") || "all around"
        );
