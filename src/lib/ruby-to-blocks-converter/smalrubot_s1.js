...
const SENSOR_POSITIONS = ["left", "right", "touch", "light", "sound"];
            ...
            switch (name) {
                case "action":
                    if (
                        ...
                        ACTIONS.includes(args[0].toString())
                    ) {
                        ...
                        block = this._changeRubyExpressionBlock(
                            receiver,
                            "smalrubotS1_actionAndStopAfter",
                            "statement"
                        );
                        this._addField(block, "ACTION", args[0]);
                ...
                case "sensor_value":
                    if (
                        args.length === 1 &&
                        this._isString(args[0]) &&
                        SENSOR_POSITIONS.includes(args[0].toString())
                    ) {
                        block = this._changeRubyExpressionBlock(
                            receiver,
                            "smalrubotS1_getSensorValue",
                            "value"
                        );
                ...
                case "led":
                    if (
                        args.length === 2 &&
                        this._isString(args[0]) &&
                        POSITIONS.includes(args[0].toString()) &&
