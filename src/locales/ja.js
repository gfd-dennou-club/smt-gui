export default {
    ...
    "microcom.i2c_write_2": "I2C (出力): I2C: アドレス 0x[NUM1], コマンド 0x[NUM2]",
    "microcom.i2c_read": "I2C (入力): スレーブアドレス 0x[NUM1], バイト数 [NUM2], アドレス [NUM3]",
    "microcom.i2c_read_2": "I2C (入力): スレーブアドレス 0x[NUM1], バイト数 [NUM2]",
    "microcom.uart_init": "UART-[TEXT] を初期化．通信速度 [NUM]",
    "microcom.uart_write": "UART-[TEXT1] (出力): [TEXT2]",
    "microcom.uart_read": "UART-[TEXT] (入力)",
    "microcom.ms_sleep": "[NUM1] ミリ秒待つ",
    "microcom.array_get": "[NUM1]の[NUM2]番目の値",
    "microcom.ord": "[NUM1]の文字コード",
    "microcom.puts": "[TEXT]のデバッグ出力",
    //
    "kanirobo1.name": "かにロボ",
