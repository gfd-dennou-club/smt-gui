...
export default function (Generator) {
    ...
    Generator.microcom_pwm_init = function (block){
        const pin   = Generator.valueToCode(block, 'PIN',   Generator.ORDER_NONE) || null;
        const timer = Generator.valueToCode(block, 'TIMER', Generator.ORDER_NONE) || null;
        const chan  = Generator.valueToCode(block, 'CHAN',  Generator.ORDER_NONE) || null;
    ...
    Generator.microcom_pwm_pulse = function (block) {
        const pin   = Generator.valueToCode(block, 'PIN', Generator.ORDER_NONE) || null;
        const pulse = Generator.valueToCode(block, 'PULSE', Generator.ORDER_NONE) || null;
    ...
    Generator.microcom_i2c_init = function (block) {
        const scl = Generator.valueToCode(block, 'SCL', Generator.ORDER_NONE) || 23;
        const sda = Generator.valueToCode(block, 'SDA', Generator.ORDER_NONE) || 22;
        return `i2c = I2C.new( ${scl}, ${sda} )\n`;
    };

    Generator.microcom_i2c_write = function (block) {
        const addr = Generator.valueToCode(block, 'ADDR', Generator.ORDER_NONE) || null;
    ...
    Generator.microcom_i2c_read = function (block) {
        const addr  = Generator.valueToCode(block, 'ADDR',  Generator.ORDER_NONE) || null;
        const bytes = Generator.valueToCode(block, 'BYTES', Generator.ORDER_NONE) || 1;
    ...
    Generator.microcom_uart_init = function (block) {
        ...
        const rate = Generator.valueToCode(block, 'RATE', Generator.ORDER_NONE) || null;
