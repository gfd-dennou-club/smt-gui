...
export default function (Generator) {
    ...
    Generator.ev3_whenButtonPressed = function (block) {
        ...
        const port =
            Generator.valueToCode(block, "PORT", Generator.ORDER_NONE) || null;
    ...
    Generator.ev3_motorTurnClockwise = function (block) {
        const port =
            Generator.valueToCode(block, "PORT", Generator.ORDER_NONE) || null;
        const time =
            Generator.valueToCode(block, "TIME", Generator.ORDER_NONE) || null;
    ...
    Generator.ev3_whenDistanceLessThan = function (block) {
        block.isStatement = true;
        const distance =
            Generator.valueToCode(block, "DISTANCE", Generator.ORDER_NONE) ||
            null;
    ...
    Generator.ev3_beep = function (block) {
        const note =
            Generator.valueToCode(block, "NOTE", Generator.ORDER_NONE) || null;
        const time =
            Generator.valueToCode(block, "TIME", Generator.ORDER_NONE) || null;
