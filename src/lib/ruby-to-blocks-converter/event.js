...
const GreaterThanMenu = ["LOUDNESS", "TIMER"];
    ...
    register: function (converter) {
        converter.registerCallMethodWithBlock(
            ...
            (params) => {
                ...
                const block = converter.createBlock(
        ...
        converter.registerCallMethodWithBlock(
            ...
            (params) => {
                ...
                const broadcastMsg = converter.lookupOrCreateBroadcastMsg(
                    args[0]
                );
                const block = converter.createBlock(
        ...
        const createBroadcastBlockFunc = (params, opcode) => {
            ...
            const menuBlock = converter.createBlock(
        ...
        converter.registerCallMethod("self", "broadcast", 1, (params) =>
            createBroadcastBlockFunc(params, "event_broadcast")
        );
        converter.registerCallMethod(
            ...
            1,
            (params) =>
                createBroadcastBlockFunc(params, "event_broadcastandwait")
        );
