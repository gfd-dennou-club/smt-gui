...
const RotationStyle = ["left-right", "don't rotate", "all around"];
            ...
            switch (name) {
                ...
                case "go_to":
                    if (args.length === 1) {
                        if (this._isString(args[0])) {
                            ...
                            this._isArray(args[0]) &&
                            args[0].length === 2 &&
                            this._isNumberOrBlock(args[0].value[0]) &&
                            this._isNumberOrBlock(args[0].value[1])
                        ) {
                            block = this._createBlock(
                                "motion_gotoxy",
                                "statement"
                ...
                case "rotation_style=": {
                    if (
                        ...
                        RotationStyle.indexOf(args[0].toString()) >= 0
                    ) {
                        block = this._createBlock(
